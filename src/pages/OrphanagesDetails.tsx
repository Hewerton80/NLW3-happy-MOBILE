...
export default function OrphanageDetails() {
  ...
  const { getOrphanage, orphanage, isloadingOrphanage } = useOrphanage();
 ...
 function handleGoogleMapasRoutes(){
  Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${orphanage?.latitude},${orphanage?.longitude}`)
 }

  if (!orphanage || isloadingOrphanage) {
    return (
    ...
    <ScrollView style={styles.container}>
        ...
        <ScrollView horizontal pagingEnabled>
          {
            orphanage.images.map(image => {
              console.log(`${URL_BACK_END}/files/${image.name}`)
              return (<Image key={image.id} style={styles.image} source={{ uri: `${URL_BACK_END}/files/${image.name}` }} />)
            })
          }
        </ScrollView>
      </View>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handleGoogleMapasRoutes} style={styles.routesContainer}>
